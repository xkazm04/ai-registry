...
| [`research`](skills/research/SKILL.md) | `ai-native` | 0.5.0 | Mine an external source - a video, an article, pasted notes - for what it changes here, and in the connected projects that consume it. Carries [`LESSONS.md`](skills/research/LESSONS.md). |
