...
[hitl-approval](../../llm-agent/orchestration/hitl-approval/hitl-approval.md), specialized to the
...
design itself is [audit-logging](../../operations/governance-and-records/audit-logging/audit-logging.md)'s
...
- **Inbound message authentication at scale** — verifying signed deliveries
  ...
  [webhook-ingestion](../../backend-platform/resilience/webhook-ingestion/webhook-ingestion.md); pairing is
  the one-time ceremony, not the per-message check.
- **Human review of individual actions** — approval queues and consent gates
  in general are [hitl-approval](../../llm-agent/orchestration/hitl-approval/hitl-approval.md); this
