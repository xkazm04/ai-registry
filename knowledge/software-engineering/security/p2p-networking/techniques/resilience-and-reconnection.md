...
- **Backoff with jitter** for blind retries — the schedule and its
  ceilings are the [retry & backoff](../../../backend-platform/resilience/retry-backoff/retry-backoff.md)
...
(dirty marks, cursors —
[change-tracking-and-cursors](../../../backend-platform/data-layer/sync-replication/techniques/change-tracking-and-cursors.md)),
