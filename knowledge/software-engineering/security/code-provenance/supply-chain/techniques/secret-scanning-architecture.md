...
- **At merge — the binding backstop.** The announced skip is only
  ...
  [gate-liveness](../../../../engineering-process/standards-and-gates/quality-gates/techniques/gate-liveness.md).
...
([false-positive-economics](../../../../engineering-process/standards-and-gates/quality-gates/techniques/false-positive-economics.md)).
