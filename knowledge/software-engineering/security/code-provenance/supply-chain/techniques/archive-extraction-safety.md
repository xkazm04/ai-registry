...
- **Digest verification precedes extraction.** The downloaded artifact
  ...
  owned by
  [source-pinning](../../../../llm-agent/runtime-and-io/sidecar-provisioning/techniques/source-pinning.md)
...
- **Extract into quarantine, validate, then promote atomically.** The
  ...
  [atomic-downloads](../../../../llm-agent/runtime-and-io/sidecar-provisioning/techniques/atomic-downloads.md),
  one layer up.
