...
The **credential vault** ([credential-vault](../../identity-and-access/credential-vault/credential-vault.md))
...
**Authorization** ([authorization](../../identity-and-access/authorization/authorization.md)) owns the
