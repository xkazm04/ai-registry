...
- **Foreign media players** — an embedded third-party *player* (video,
  ...
  belongs to [media-playback](../../../ui-surfaces/shell-and-navigation/media-playback/media-playback.md)'s
  [engine-adapters](../../../ui-surfaces/shell-and-navigation/media-playback/techniques/engine-adapters.md): the
...
[subprocess-lifecycle](../../../llm-agent/runtime-and-io/subprocess-lifecycle/subprocess-lifecycle.md) and
is linked from there rather than restated —
[termination-and-reaping](../../../llm-agent/runtime-and-io/subprocess-lifecycle/techniques/termination-and-reaping.md)
...
[undo-history](../../../ui-surfaces/input-and-editing/undo-history/undo-history.md), and its
...
owned by [prompt-safety](../../../llm-agent/prompt-and-context/prompt-safety/prompt-safety.md): fence the
