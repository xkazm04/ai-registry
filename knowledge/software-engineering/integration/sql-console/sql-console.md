...
- The application's **own** persistence layer — repositories, migrations,
  ...
  [data-access](../../backend-platform/data-layer/data-access/data-access.md). The two look superficially
...
- The NL-assist lane's **extraction machinery** — getting well-formed SQL out
  ...
  [structured-output](../../llm-agent/prompt-and-context/structured-output/structured-output.md)'s subject.
