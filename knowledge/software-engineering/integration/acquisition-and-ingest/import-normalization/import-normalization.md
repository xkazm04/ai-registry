...
- **sanitization at the sink boundary** — text that will reach a prompt is
  fenced as untrusted the way [prompt-safety](../../../llm-agent/prompt-and-context/prompt-safety/prompt-safety.md)
...
sense of [wizard-flows](../../../ui-surfaces/input-and-editing/wizard-flows/wizard-flows.md) — staged state,
