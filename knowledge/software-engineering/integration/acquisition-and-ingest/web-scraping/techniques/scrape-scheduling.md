...
[scheduling](../../../../backend-platform/work-execution/scheduling/scheduling.md) subject, and a scraper **rides
...
- **blocked** — the target is refusing or throttling (denial status codes,
  ...
  the [retry-backoff](../../../../backend-platform/resilience/retry-backoff/retry-backoff.md) posture for
