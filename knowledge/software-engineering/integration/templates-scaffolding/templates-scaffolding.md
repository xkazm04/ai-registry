...
no human choice at the point of use (that is [codegen](../../engineering-process/build-and-release/codegen/codegen.md)
...
restored ([versioning-snapshots](../../operations/governance-and-records/versioning-snapshots/versioning-snapshots.md)
