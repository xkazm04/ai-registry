...
[build-economics](../../build-and-release/build-economics/build-economics.md) for the wider ledger); a
...
- **Enforcement gates.** Wiring an instrument into a blocking check — and the
  ...
  [quality-gates](../../standards-and-gates/quality-gates/quality-gates.md); this subject feeds it
  instruments whose verdicts have earned trust.
- **Generator lifecycle.** Why generators add and never delete, and how generated
  trees are owned and regenerated, is [codegen](../../build-and-release/codegen/codegen.md); this subject
