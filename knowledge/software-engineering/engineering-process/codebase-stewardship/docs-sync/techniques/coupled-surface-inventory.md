...
- **onboarding tours** — coupled when the changed flow is one a tour walks;
  what a step contains is [guided-tours](../../../../ui-surfaces/shell-and-navigation/guided-tours/guided-tours.md)'
...
- **translations and changelogs** — owed through their own subjects'
  disciplines ([i18n](../../../../client-architecture/i18n/i18n.md),
  [release-pipeline](../../../build-and-release/release-pipeline/release-pipeline.md)); the
