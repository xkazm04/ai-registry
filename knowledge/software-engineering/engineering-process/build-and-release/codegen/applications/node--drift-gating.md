...
[drift-gates](../../../../client-architecture/ipc-contract/techniques/drift-gates.md); inventory
findings in
codegen-task-registration (`docs/concepts/golden-paths/codegen-task-registration.md`)
§7 B).
