...
the [quality-gates](../quality-gates/quality-gates.md) subject, and it is
...
[scoring-rubrics](../scoring-rubrics/scoring-rubrics.md); this subject owns
...
[test-harness](../test-harness/test-harness.md) — the one testing technique
