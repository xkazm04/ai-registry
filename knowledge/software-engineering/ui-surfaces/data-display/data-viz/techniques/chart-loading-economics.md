...
- The chart's slot renders immediately at **final height**, holding layout
  ...
  [async-ui-states](../../../feedback-and-style/async-ui-states/async-ui-states.md).
...
- The observation is one-shot per chart: once mounted, a chart stays mounted
  ...
  entrance rules per
  [arrival-choreography](../../../feedback-and-style/async-ui-states/techniques/arrival-choreography.md)).
