...
- **A [table](../table/table.md)** when the job is comparison across uniform
  ...
  machinery.
- **A triage queue** ([triage-queues](../../../operations/service-operations/triage-queues/triage-queues.md))
...
- **A transcript** ([chat-transcript](../../shell-and-navigation/chat-transcript/chat-transcript.md))
...
- **An audit record** ([audit-logging](../../../operations/governance-and-records/audit-logging/audit-logging.md))
