...
belongs to the [voice-io](../../../llm-agent/runtime-and-io/voice-io/voice-io.md) subject. The two meet at
...
The speech pipeline belongs to [voice-io](../../../llm-agent/runtime-and-io/voice-io/voice-io.md), but its
...
[tts-pipeline](../../../llm-agent/runtime-and-io/voice-io/techniques/tts-pipeline.md) under "the synthesis
