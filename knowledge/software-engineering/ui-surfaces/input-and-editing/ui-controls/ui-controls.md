...
[design-tokens](../../feedback-and-style/design-tokens/design-tokens.md). What is worth
...
- The **busy button**'s affordance is tied to the lifetime of the promise it
  ...
  [async-ui-states](../../feedback-and-style/async-ui-states/async-ui-states.md) as the shared
  [action-busy-states](../../feedback-and-style/async-ui-states/techniques/action-busy-states.md)
...
[accessibility](../../feedback-and-style/accessibility/accessibility.md) and its
[primitive-level-a11y](../../feedback-and-style/accessibility/techniques/primitive-level-a11y.md)
...
- **Busy, loading, empty, and failed states** — the async state doctrine —
  is [async-ui-states](../../feedback-and-style/async-ui-states/async-ui-states.md); this library
...
- **Primitive-level accessibility standards** (naming, keyboard models, live
  regions) are [accessibility](../../feedback-and-style/accessibility/accessibility.md); the
  library is where those standards get *implemented once*.
- **The visual vocabulary** — color, spacing, radius, type, motion tokens —
  is [design-tokens](../../feedback-and-style/design-tokens/design-tokens.md); controls consume
