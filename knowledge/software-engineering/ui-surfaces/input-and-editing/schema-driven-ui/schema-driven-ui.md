...
- **A model composes the surface.** An assistant summarizes a situation and
  ...
  model turn is owned by [structured-output](../../../llm-agent/prompt-and-context/structured-output/structured-output.md);
...
[hitl-approval](../../../llm-agent/orchestration/hitl-approval/hitl-approval.md), specifically
[consent-gates](../../../llm-agent/orchestration/hitl-approval/techniques/consent-gates.md)). The wiring — action
