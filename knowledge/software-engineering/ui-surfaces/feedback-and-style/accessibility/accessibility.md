...
- **Overlay focus containment** — trap, restore, and scroll lock inside
  ...
  [modal-stack](../../shell-and-navigation/modal-stack/modal-stack.md), specifically
  [focus-and-scroll-containment](../../shell-and-navigation/modal-stack/techniques/focus-and-scroll-containment.md).
- **Field wiring** — label/hint/error association inside form fields —
  [form](../../input-and-editing/form/form.md), specifically
  [field-composition](../../input-and-editing/form/techniques/field-composition.md).
