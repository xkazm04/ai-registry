...
shared [token-label-separation](../../../client-architecture/i18n/techniques/token-label-separation.md)
technique, owned by [i18n](../../../client-architecture/i18n/i18n.md).

What this subject does **not** own: which member may follow which — the
transition rules of a lifecycle — belongs to
[entity-lifecycle](../../../operations/governance-and-records/entity-lifecycle/entity-lifecycle.md); codes that
describe a *failure* and route through error resolution belong to
[error-handling](../../../backend-platform/resilience/error-handling/error-handling.md); the catalog
machinery itself to [i18n](../../../client-architecture/i18n/i18n.md). This subject owns codes that
...
[prompt-safety](../../../llm-agent/prompt-and-context/prompt-safety/prompt-safety.md)'s
...
- [token-label-separation](../../../client-architecture/i18n/techniques/token-label-separation.md)
  *(shared, owned by [i18n](../../../client-architecture/i18n/i18n.md))* — tokens are identity,
