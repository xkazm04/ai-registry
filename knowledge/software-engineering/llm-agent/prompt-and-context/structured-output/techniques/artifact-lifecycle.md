...
- **Extraction happens on the settled record**, never on the live tail. The
  boundary with [streaming-output](../../../runtime-and-io/streaming-output/streaming-output.md)
...
the discipline [streaming-output](../../../runtime-and-io/streaming-output/streaming-output.md)
