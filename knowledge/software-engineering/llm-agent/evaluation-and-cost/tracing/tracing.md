...
([streaming-output](../../runtime-and-io/streaming-output/streaming-output.md)). The two are
...
([error-handling](../../../backend-platform/resilience/error-handling/error-handling.md)), so "which category of
