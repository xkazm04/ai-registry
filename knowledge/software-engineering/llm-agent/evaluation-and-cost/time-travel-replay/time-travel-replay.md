...
- **Not the live surface.** The stream a user watches during the run —
  ...
  [streaming-output](../../runtime-and-io/streaming-output/streaming-output.md). Replay
...
- **Not undo.** A replay **views** the past; undo **changes** the present
  ([undo-history](../../../ui-surfaces/input-and-editing/undo-history/undo-history.md)). Scrubbing to an earlier
