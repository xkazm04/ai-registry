...
[background-jobs](../../../backend-platform/work-execution/background-jobs/background-jobs.md); this subject begins
...
killed is [retry-backoff](../../../backend-platform/resilience/retry-backoff/retry-backoff.md)'s subject;
deciding *when* recurring child work runs at all is
[scheduling](../../../backend-platform/work-execution/scheduling/scheduling.md)'s.
