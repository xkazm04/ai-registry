...
the bytes are the target). [packaging](../../../../engineering-process/build-and-release/packaging/packaging.md)
applies the same sniff to payloads at build time
([os-arch-matrix](../../../../engineering-process/build-and-release/packaging/techniques/os-arch-matrix.md)); this
