...
[pipeline](../../../backend-platform/work-execution/pipeline-dag/pipeline-dag.md) is **orchestrator-driven**: one
...
storage, fan-out — belongs to [realtime events](../../../client-architecture/realtime-events/realtime-events.md);
...
[scheduling](../../../backend-platform/work-execution/scheduling/scheduling.md)'s trigger-matching concern; this
...
[tracing](../../evaluation-and-cost/tracing/tracing.md)'s cross-boundary-propagation — this subject
...
[pipeline conditional edges](../../../backend-platform/work-execution/pipeline-dag/techniques/conditional-edges.md)
