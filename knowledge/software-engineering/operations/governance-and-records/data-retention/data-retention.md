...
[scheduling](../../../backend-platform/work-execution/scheduling/scheduling.md). The **runner** that hosts the
work, its supervision and its progress contract, belongs to
[background-jobs](../../../backend-platform/work-execution/background-jobs/background-jobs.md). This subject
