...
whose [checkpoint-restore](../../../ui-surfaces/input-and-editing/undo-history/techniques/checkpoint-restore.md)
...
- **Schema versioning** — versions of the *shape* of the data are the
  [migrations](../../../backend-platform/data-layer/migrations/migrations.md) subject. The two interact
...
[auto-rollback](../../../backend-platform/resilience/self-healing/techniques/auto-rollback.md) technique and
