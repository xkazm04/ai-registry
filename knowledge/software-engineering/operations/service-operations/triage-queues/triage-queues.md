...
precisely. [Human-in-the-loop approval](../../../llm-agent/orchestration/hitl-approval/hitl-approval.md)
...
[review-queues](../../../llm-agent/orchestration/hitl-approval/techniques/review-queues.md) discipline
rather than reinventing verdict-binding rules here.

A triage surface is also **not a [table](../../../ui-surfaces/data-display/table/table.md)**, however much
...
[queue completeness](../../../llm-agent/orchestration/hitl-approval/techniques/review-queues.md) —
...
belongs in [async-ui-states](../../../ui-surfaces/feedback-and-style/async-ui-states/async-ui-states.md);
announcements belong in
[toasts-notifications](../../../ui-surfaces/feedback-and-style/toasts-notifications/toasts-notifications.md). The
...
[approval subject](../../../llm-agent/orchestration/hitl-approval/hitl-approval.md) and worth restating in
inbox terms:
...
- **Blocking gates.** Anything where a machine waits on the verdict —
  ...
  [hitl-approval](../../../llm-agent/orchestration/hitl-approval/hitl-approval.md), even when it is
  *displayed* inside a unified inbox.
- **Pure notification delivery.** Fire-and-forget announcements with no
  verdict are [toasts-notifications](../../../ui-surfaces/feedback-and-style/toasts-notifications/toasts-notifications.md);
...
- **The producers themselves.** Detection quality — whether an incident
  ...
  (e.g. [error-handling](../../../backend-platform/resilience/error-handling/error-handling.md),
  [background-jobs](../../../backend-platform/work-execution/background-jobs/background-jobs.md)). The queue's
