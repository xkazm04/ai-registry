...
sparkline, the meter, the panel — is [data-viz](../../../ui-surfaces/data-display/data-viz/data-viz.md)'s
...
[ipc-contract](../../../client-architecture/ipc-contract/ipc-contract.md)'s subject; what the
application's boot sequence *is* belongs to
[app-shell](../../../ui-surfaces/shell-and-navigation/app-shell/app-shell.md) — this subject only times it). A
...
[data-viz](../../../ui-surfaces/data-display/data-viz/data-viz.md)'s), persisted where cross-run
