...
registry of its surfaces — the [app shell](../../../ui-surfaces/shell-and-navigation/app-shell/app-shell.md)'s
...
product's [error doors](../../../backend-platform/resilience/error-handling/techniques/error-doors.md) — a sink
