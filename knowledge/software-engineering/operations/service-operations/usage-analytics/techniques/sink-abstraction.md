...
[error handling](../../../../backend-platform/resilience/error-handling/error-handling.md) standard defines:
...
- **Never silent to operators.** The failure goes through the background
  [error door](../../../../backend-platform/resilience/error-handling/techniques/error-doors.md) — logged,
