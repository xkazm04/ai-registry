...
[retry-backoff](../../../resilience/retry-backoff/techniques/error-classification-for-retry.md));
...
- Consequence gating composes: an adapter whose action is irreversible or
  ...
  of it ([hitl-approval](../../../../llm-agent/orchestration/hitl-approval/hitl-approval.md) owns when
