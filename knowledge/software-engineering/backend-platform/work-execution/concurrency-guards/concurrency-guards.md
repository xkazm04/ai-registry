...
[client state](../../../client-architecture/client-state/client-state.md) owns UI-side async races
([async-race-guards](../../../client-architecture/client-state/techniques/async-race-guards.md));
[concurrent version control](../../../engineering-process/codebase-stewardship/concurrent-vcs/concurrent-vcs.md) owns
