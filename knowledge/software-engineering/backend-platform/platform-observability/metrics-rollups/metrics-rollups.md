...
adjacent subject: [data-viz](../../../ui-surfaces/data-display/data-viz/data-viz.md) owns metric identity and
display; the [metric-identity](../../../ui-surfaces/data-display/data-viz/techniques/metric-identity.md)
...
- **A client-side fold is a second implementation of the metric.** It will
  ...
  [metric-identity](../../../ui-surfaces/data-display/data-viz/techniques/metric-identity.md) technique
...
- **A second ad-hoc fold for a second surface.** The export, the alert
  ...
  [metric-identity](../../../ui-surfaces/data-display/data-viz/techniques/metric-identity.md).
