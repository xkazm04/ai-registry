...
- They are **two call sites**. Filters, timezone parameters, and metric
  ...
  [metric-identity](../../../../ui-surfaces/data-display/data-viz/techniques/metric-identity.md) contract
...
- **Sign and goodness are different axes.** The computation returns the
  ...
  polarity — owned by
  [metric-identity](../../../../ui-surfaces/data-display/data-viz/techniques/metric-identity.md), resolved
