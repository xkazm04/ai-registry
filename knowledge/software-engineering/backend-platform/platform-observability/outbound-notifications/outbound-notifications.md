...
- **The dispatch loop is not this subject.** Durable watermarks, forward-only
  ...
  [outbound fan-out](../../../client-architecture/realtime-events/techniques/outbound-fan-out.md)
  technique, owned by [realtime-events](../../../client-architecture/realtime-events/realtime-events.md).
...
- **In-app delivery is not this subject.** Toasts, the durable ledger, and
  ...
  [os-escalation](../../../ui-surfaces/feedback-and-style/toasts-notifications/techniques/os-escalation.md)
...
- **Attention policy is not this subject.** Whether the user should be
  ...
  is [proactive-nudges](../../../llm-agent/orchestration/proactive-nudges/proactive-nudges.md). An
...
- **Retry ladders and breaker theory are not this subject.**
  [retry-backoff](../../resilience/retry-backoff/retry-backoff.md) owns backoff design and
  [circuit breakers](../../resilience/retry-backoff/techniques/circuit-breakers.md) in
...
- **Inbound HTTP ingestion is not this subject** — events arriving *from*
  ...
  [webhook-ingestion](../../resilience/webhook-ingestion/webhook-ingestion.md). But
...
[fan-out](../../../client-architecture/realtime-events/techniques/outbound-fan-out.md) technique.
