...
- **Tier 3 — irreversible or externally visible.** Deleting data, invoking
  ...
  [health-checks](../../../../operations/service-operations/health-checks/techniques/remediation-affordances.md)
  owns and the approval flows that
  [hitl-approval](../../../../llm-agent/orchestration/hitl-approval/hitl-approval.md) owns.
