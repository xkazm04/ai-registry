...
- [Health checks](../../../operations/service-operations/health-checks/health-checks.md) owns remediation affordances
...
[audit-logging](../../../operations/governance-and-records/audit-logging/audit-logging.md) discipline applies to machine
...
escalation surfaces that [alerting](../../platform-observability/alerting/alerting.md) and
[triage-queues](../../../operations/service-operations/triage-queues/triage-queues.md) own).
