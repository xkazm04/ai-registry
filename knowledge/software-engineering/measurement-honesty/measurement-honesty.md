...
[Scoring rubrics](../scoring-rubrics/scoring-rubrics.md) own the *composite*:
...
[Metrics rollups](../metrics-rollups/metrics-rollups.md) own the *mechanics of
...
[Quality gates](../quality-gates/quality-gates.md) own *enforcement* — which
