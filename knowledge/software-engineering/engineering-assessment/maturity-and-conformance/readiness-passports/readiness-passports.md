...
[`repo-manifest-standard`](../../../engineering-process/standards-and-gates/repo-manifest-standard/repo-manifest-standard.md) subject — is written *by* the project, at a known
