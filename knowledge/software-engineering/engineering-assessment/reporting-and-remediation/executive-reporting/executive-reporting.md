...
[metrics-rollups](../../../backend-platform/platform-observability/metrics-rollups/metrics-rollups.md) owns the fold —
bucketing, windows, comparisons, stored derivations — and its
[aggregate-honesty](../../../backend-platform/platform-observability/metrics-rollups/techniques/aggregate-honesty.md)
...
present — belong to
[measurement-honesty](../../measurement-method/measurement-honesty/measurement-honesty.md); we
consume its verdicts and are responsible for not laundering them out of the
narrative.

Machine-consumable extraction is [structured-output](../../../llm-agent/prompt-and-context/structured-output/structured-output.md)'s
...
The nearest sibling is [`judgment-guardbands`](../../../llm-agent/evaluation-and-cost/judgment-guardbands/judgment-guardbands.md), and the seam is worth stating
