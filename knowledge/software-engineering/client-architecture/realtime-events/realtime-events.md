...
[streaming output](../../llm-agent/runtime-and-io/streaming-output/streaming-output.md). The boundary is
...
[buffering and backpressure](../../llm-agent/runtime-and-io/streaming-output/techniques/buffering-and-backpressure.md)
