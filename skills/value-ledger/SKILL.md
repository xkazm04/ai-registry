...
```sh
node <registry>/scripts/log-run.mjs --skill value-ledger --outcome <o> --difficulty <1-5> \
...
Otherwise write the line yourself: `{"ts":"<ISO, UTC Z>","skill":"value-ledger","outcome":…,
