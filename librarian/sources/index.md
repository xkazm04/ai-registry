...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-08-26 | `youtube:g3X8JauSWTM` - "Stop Building AI Slop - Build High-End Web Apps with AI" | practitioner-tutorial (course walkthrough) | 14649 | 12 | 1 | 0 | 11 | [[2026-08-26-stop-building-ai-slop]] - longest source in the ledger, one amendment: cross-medium probes on `asset-vs-disposable-render` (the probe ladder, and the dropped dimension is unsettled not approved); class row earned on second observation; identity-slot convergence banked with 2026-08-23 |
