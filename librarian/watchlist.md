...
| unicode-org/cldr — common/rbnf/<lang>.xml | B, executable rules, **no publisher fixture** | CONSUMED for korean (counting-and-quantity) and russian (gender-and-aspect) | measured: interpreters written twice, both at oracle parity (6030/6030 against the reference impl; 1380-row cross-encoding check). Locale-agnostic and reusable. **Two upstream defects found.** |
