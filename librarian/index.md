...
| [`upstream.md`](upstream.md) | Every mined GitHub repository: when we last looked, whether it has moved since our pin, and whether it is due for a delta re-scan. Generated by [`scripts/upstream-check.mjs`](../scripts/upstream-check.mjs); designed in [`docs/plans/upstream-lane-2026-09-04.md`](../docs/plans/upstream-lane-2026-09-04.md). |
